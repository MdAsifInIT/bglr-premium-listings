...
export function StepPricing() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-xs font-semibold text-zinc-300 uppercase tracking-wider mb-2" htmlFor="listingType">
          Listing Type
        </label>
        <select
          id="listingType"
      ...
      <div>
        <label className="block text-xs font-semibold text-zinc-300 uppercase tracking-wider mb-2" htmlFor="price">
          Price (INR)
        </label>
        <Input
          id="price"
