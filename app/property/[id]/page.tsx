...
export default async function PropertyPage({ params }: PropertyPageProps) {
  ...
  return (
    <div className="flex-1 bg-stone-50 dark:bg-zinc-950 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Description */}
        <div className="bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 rounded-xl p-6 mb-8 shadow-sm">
        ...
        {/* Owner Contact */}
        <div className="bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm">
